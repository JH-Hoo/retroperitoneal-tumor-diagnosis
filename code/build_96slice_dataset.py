...
RAW_ROOT = PROJECT_ROOT / "data" / "standard"
...
def main():
    ...
    write_rows(OUT_ROOT / "header_audit.csv", audit_rows)
    ...
    (OUT_ROOT / "README.md").write_text(
        ...
        "Offline preprocessed cache derived from `data/standard`.\n\n"
